...
function openPage(id){
    ...
    switch(id){
        case 'page1':
            newApi = "https://api.themoviedb.org/3/discover/movie?sort_by=popularity.desc&api_key=04c35731a5ee918f014970082a0088b1&page=1";
            getPopularMovie(newApi);
            setButton('1');
            break;
        case 'page2':
            newApi = "https://api.themoviedb.org/3/discover/movie?sort_by=popularity.desc&api_key=04c35731a5ee918f014970082a0088b1&page=2";
            getPopularMovie(newApi);
            setButton('2');
            break;
        case 'page3':
            newApi = "https://api.themoviedb.org/3/discover/movie?sort_by=popularity.desc&api_key=04c35731a5ee918f014970082a0088b1&page=3";
            getPopularMovie(newApi);
            setButton('3');
            break;
        case 'page4':
            newApi = "https://api.themoviedb.org/3/discover/movie?sort_by=popularity.desc&api_key=04c35731a5ee918f014970082a0088b1&page=4";
            getPopularMovie(newApi);
            setButton('4');
            break;
        case 'page5':
            newApi = "https://api.themoviedb.org/3/discover/movie?sort_by=popularity.desc&api_key=04c35731a5ee918f014970082a0088b1&page=5";
            getPopularMovie(newApi);
            setButton('5');
            break;
    }
